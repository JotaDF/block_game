...
$string['help_score_text'] = 'O jogo possui sistema de pontuação pois a pontuação do jogador definirá a sua classificação e o nível que se encontra. Por isso é muito importante você saber como ganhar pontos para melhorar sua colocação e seu nível.<br/>
<br/><strong>Como conseguir pontos:</strong><br/>';
$string['help_score_activities_text'] = '<strong>Pontos de atividades</strong> - ao fazer as atividades propostas nos cursos que está matriculado, a nota alcançada será convertida em pontos do jogo! Portanto alcance as melhores notas nas atividades para ganhar mais pontos!<br/>';
...
$string['help_rank_criterion_text'] = '<strong>Critérios de desempate</strong> - O total de pontos define a classificação dos usuários, porém em algumas situações esse total pode ser o mesmo de outros jogadores ocorrendo um empate, nesse caso a posição do jogador é definida seguindo os seguintes critérios:<br/><br/><strong>1&ordm; </strong> - O jogador que tiver maior pontuação conquistada por emblema;<br/><strong>2&ordm; </strong> - O jogador que tiver maior pontuação conquistada por atividades;<br/><strong>3&ordm; </strong> - O jogador mais antigo do ambiente, ou seja, que foi cadastrado primeiro.<br/>';
