...
$string['help_score_text'] = 'The game has a scoring system because the player\'s score will define his rating and the level he is at. So it is very important that you know how to earn points to improve your placement and your level.<br/>
...
$string['help_rank_criterion_text'] = '<strong>Breakout Criteria</strong> - The total number of points defines the classification of users, however in some situations this total may be the same as that of other players in the event of a tie, in which case the position of the player is defined according to the following criteria:<br/><br/><strong>1&ordm; </strong> - The player with the highest score won by badge;<br/><strong>2&ordm; </strong> - The player who has the highest score earned by activities;<br/><strong>3&ordm; </strong> - The oldest player in the environment, that is, that was registered first.<br/>';
