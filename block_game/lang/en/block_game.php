...
$string['config_level_up'] = 'Score level up';
$string['config_level_up_help'] = '<p>Sets the score to level up.</p>';
...
$string['config_score_activities_help'] = '<p>use activity notes to score.</p>';
